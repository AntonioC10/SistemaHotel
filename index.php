                ...
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-md-10 col-sm-12 col-xs-10">
                            <h4 class="pTitle">Sistema Gestor de Hoteles</h4>
                            </div>
                    </div>
                    ...
                    <form name="login" action="index.php" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                        <fieldset>
                            <div class="form-group">
                                <input class="form-control" placeholder="Email / ID" name="email" type="text" autofocus required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="checkbox">
                                ...
                                <a href="forget.html" class="red pull-right">Olvidé mi contraseña</a>
                                <label id="loginMsg" class="red"><?php echo $msg ?></label>
                            </div>
                            <!-- Change this to a button or input when using this as a form -->

                            <button type="submit" name="btnLogin" class="btn btn-lg btn-success btn-block"><i class="glyphicon glyphicon-log-in"></i> Iniciar Sesión</button>
                        </fieldset>
                    </form>
                </div>
            </div>
